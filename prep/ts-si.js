...
QUESTION_BANK["General Studies"] = [
  {q:"Under which Article of the Constitution can Parliament form a new State?",
   opts:["Article 1","Article 2","Article 3","Article 4"], correct:2, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-polity", concept:"Article 3 carves states from inside the Union",
  ...
  {q:"The Fundamental Duties were added to the Constitution by which amendment?",
   opts:["42nd Amendment","44th Amendment","52nd Amendment","61st Amendment"], correct:0, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-polity", concept:"The 42nd Amendment and what it added",
  ...
  {q:"Which House of Parliament can be dissolved?",
   opts:["Rajya Sabha","Lok Sabha","Both Houses","Neither House"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-polity", concept:"Lok Sabha is dissolvable, Rajya Sabha is permanent",
  ...
  {q:"NITI Aayog replaced which body?",
   opts:["Finance Commission","Planning Commission","Election Commission","National Development Council"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-economy", concept:"NITI Aayog replaced the Planning Commission",
  ...
  {q:"The Reserve Bank of India was established in which year?",
   opts:["1921","1935","1947","1949"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-economy", concept:"RBI's founding year",
  ...
  {q:"The Quit India Movement was launched in which year?",
   opts:["1930","1935","1942","1946"], correct:2, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-history", concept:"Quit India, 1942",
  ...
  {q:"Who founded the Indian National Congress in 1885?",
   opts:["A. O. Hume","W. C. Bonnerjee","Dadabhai Naoroji","Surendranath Banerjee"], correct:0, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-history", concept:"The founding of the Congress",
  ...
  {q:"The Jallianwala Bagh massacre took place in which year?",
   opts:["1914","1919","1922","1927"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-history", concept:"Jallianwala Bagh, 1919",
  ...
  {q:"The Tropic of Cancer passes through how many Indian states?",
   opts:["Six","Seven","Eight","Nine"], correct:2, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-geography", concept:"The Tropic of Cancer across India",
  ...
  {q:"Which Indian state has the longest coastline?",
   opts:["Tamil Nadu","Andhra Pradesh","Gujarat","Maharashtra"], correct:2, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-geography", concept:"Coastline lengths by state",
  ...
  {q:"The Godavari river rises at Trimbakeshwar in which state?",
   opts:["Madhya Pradesh","Maharashtra","Karnataka","Telangana"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-geography", concept:"Source of the Godavari",
  ...
  {q:"Which is the longest river flowing entirely within India?",
   opts:["Brahmaputra","Godavari","Indus","Ganga"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-geography", concept:"Rivers entirely within India",
  ...
  {q:"The SI unit of force is the?",
   opts:["Joule","Newton","Pascal","Watt"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-science", concept:"SI unit of force",
  ...
  {q:"Deficiency of which vitamin causes scurvy?",
   opts:["Vitamin A","Vitamin B12","Vitamin C","Vitamin D"], correct:2, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-science", concept:"Vitamin C and scurvy",
  ...
  {q:"The chemical symbol Na stands for which element?",
   opts:["Nitrogen","Sodium","Nickel","Neon"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"gs-science", concept:"Chemical symbol for sodium",
  ...
  {q:"The Directive Principles of State Policy are contained in which Part of the Constitution?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-polity", concept:"Directive Principles are in Part IV",
  ...
  {q:"What is the minimum age for election to the Lok Sabha?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"gs-polity", concept:"Minimum age for the Lok Sabha",
  ...
  {q:"Who is the constitutional head of the Indian Union?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"gs-polity", concept:"The President as constitutional head",
  ...
  {q:"The Non-Cooperation Movement was launched in which year?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"gs-history", concept:"Non-Cooperation, 1920",
  ...
  {q:"The Dandi March of 1930 was a protest against which law?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-history", concept:"The Dandi March and the salt law",
  ...
  {q:"Who was the first Governor-General of independent India?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-history", concept:"First Governor-General of independent India",
  ...
  {q:"Which is the highest mountain peak located entirely within India?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-geography", concept:"Highest peak wholly within India",
  ...
  {q:"The Western Ghats and the Eastern Ghats meet at?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-geography", concept:"Where the two Ghats meet",
  ...
  {q:"The southwest monsoon normally reaches the Kerala coast around?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-geography", concept:"Monsoon onset over Kerala",
  ...
  {q:"Which gas is most abundant in the Earth's atmosphere?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"gs-science", concept:"Composition of the atmosphere",
  ...
  {q:"The ozone layer is found in which layer of the atmosphere?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-environment", concept:"The ozone layer sits in the stratosphere",
  ...
  {q:"Which organ of the human body produces insulin?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"gs-science", concept:"The pancreas produces insulin",
  ...
  {q:"The SI unit of electric current is the?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"gs-science", concept:"SI unit of electric current",
  ...
  {q:"The Goods and Services Tax (GST) came into force in India in which year?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"gs-economy", concept:"GST commencement",
...
QUESTION_BANK["Telangana Movement & State Formation"] = [
  {q:"Telangana became a separate State of the Indian Union on which date?",
   opts:["2 November 2013","2 June 2014","1 November 2014","2 June 2013"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"tm-formation", concept:"Formation date of Telangana",
  ...
  {q:"Telangana was formed as which numbered state of the Indian Union?",
   opts:["27th","28th","29th","30th"], correct:2, source_type:"generated_practice", difficulty:"basic", subtopic:"tm-formation", concept:"Telangana as the 29th state",
  ...
  {q:"Which Act of Parliament created the State of Telangana?",
   opts:["The States Reorganisation Act, 1956","The Andhra Pradesh Reorganisation Act, 2014","The Telangana Formation Act, 2014","The Andhra State Act, 1953"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-formation", concept:"The Andhra Pradesh Reorganisation Act, 2014",
  ...
  {q:"Who became the first Chief Minister of Telangana?",
   opts:["N. Kiran Kumar Reddy","K. Chandrashekar Rao","Marri Chenna Reddy","N. Chandrababu Naidu"], correct:1, source_type:"generated_practice", difficulty:"basic", subtopic:"tm-formation", concept:"First Chief Minister of Telangana",
  ...
  {q:"In which year was the Telangana Rashtra Samithi founded?",
   opts:["1996","2001","2004","2009"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-formation", concept:"Founding of the TRS",
  ...
  {q:"Under the 2014 reorganisation, Hyderabad was to serve as the joint capital of Telangana and Andhra Pradesh for a maximum of how long?",
   opts:["Five years","Ten years","Fifteen years","Permanently"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-formation", concept:"The joint-capital arrangement and its term",
  ...
  {q:"The Gentlemen's Agreement of 1956 was concluded in connection with?",
   opts:["The merger of Hyderabad State's Telangana region with Andhra State","The end of the Nizam's rule","The formation of Telangana in 2014","The Six-Point Formula"], correct:0, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"The Gentlemen's Agreement, 1956",
  ...
  {q:"The Mulki rules, central to early Telangana grievances, concerned?",
   opts:["Land ownership","Preference in government employment for local residents","Irrigation rights","Language of instruction"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"The Mulki rules and local employment",
  ...
  {q:"The large-scale Telangana agitation demanding a separate state took place in which year of the 1960s?",
   opts:["1965","1967","1969","1970"], correct:2, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"The 1969 agitation",
  ...
  {q:"The 'Jai Andhra' movement of 1972 was launched?",
   opts:["In support of a separate Telangana","In the coastal Andhra and Rayalaseema regions, in reaction to the Telangana agitation","By the Telangana Praja Samithi","To oppose the States Reorganisation Act"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-mobilisation", concept:"Jai Andhra, 1972, and who launched it",
  ...
  {q:"The Six-Point Formula of 1973 was intended to?",
   opts:["Divide Andhra Pradesh","Settle regional grievances within a united Andhra Pradesh","Create a Telangana Regional Council for the first time","Abolish the Mulki rules permanently"], correct:1, source_type:"generated_practice", difficulty:"challenging", subtopic:"tm-mobilisation", concept:"The Six-Point Formula, 1973",
  ...
  {q:"The committee headed by Justice B. N. Srikrishna, constituted in 2010, was asked to?",
   opts:["Fix the boundaries of a new Telangana state","Examine the demand for a separate Telangana and recommend a course of action","Allocate river waters between the regions","Draft the reorganisation legislation"], correct:1, source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-formation", concept:"The remit of the Srikrishna Committee",
  ...
  {q:"Hyderabad State was integrated into the Indian Union in September 1948 following which operation?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"Integration of Hyderabad State, 1948",
  ...
  {q:"Andhra Pradesh was formed on 1 November 1956 by merging the Telangana region with?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"The 1956 merger that created Andhra Pradesh",
  ...
  {q:"The States Reorganisation Commission headed by Fazl Ali, reporting in 1955, suggested that Telangana?",
   ...
   source_type:"generated_practice", difficulty:"challenging", subtopic:"tm-idea", concept:"What the Fazl Ali Commission actually recommended",
  ...
  {q:"The Telangana Praja Samithi, formed during the 1969 agitation, is most associated with which leader?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"The Telangana Praja Samithi and the 1969 agitation",
  ...
  {q:"Which university was a principal centre of student mobilisation in the Telangana movement?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-idea", concept:"Osmania University as a centre of mobilisation",
  ...
  {q:"The Six-Point Formula of 1973 was given constitutional backing by inserting which Article?",
   ...
   source_type:"generated_practice", difficulty:"challenging", subtopic:"tm-mobilisation", concept:"Article 371D and the Six-Point Formula",
  ...
  {q:"G.O. 610, issued in 1985, dealt with?",
   ...
   source_type:"generated_practice", difficulty:"challenging", subtopic:"tm-mobilisation", concept:"G.O. 610 and local-cadre posts",
  ...
  {q:"On 9 December 2009, the Union Home Minister announced that?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-formation", concept:"The 9 December 2009 announcement",
  ...
  {q:"The Srikrishna Committee submitted its report in?",
   ...
   source_type:"generated_practice", difficulty:"moderate", subtopic:"tm-formation", concept:"When the Srikrishna Committee reported",
  ...
  {q:"K. Chandrashekar Rao's fast-unto-death in late 2009 was undertaken to demand?",
   ...
   source_type:"generated_practice", difficulty:"basic", subtopic:"tm-formation", concept:"The 2009 fast and what it demanded",
