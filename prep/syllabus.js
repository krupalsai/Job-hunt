...
"Digital Logic": {
  ...
  basis: "GATE CS scope, as reported for HAL's discipline section — candidate-authorised, not checked against the notification.",
  topics: [
    {t: "Boolean algebra, logic gates and universal gates", lessons: ["dl-boolean"]},
    {t: "Minimisation: K-maps and SOP/POS forms", lessons: ["dl-combinational"]},
    {t: "Combinational circuits: adders, multiplexers, decoders", lessons: ["dl-combinational"]},
    {t: "Sequential circuits: latches and flip-flops", lessons: ["dl-sequential"]},
    {t: "Counters and registers", lessons: ["dl-sequential"]},
...
"Algorithms": {
  ...
  basis: "GATE CS scope, as reported for HAL's discipline section — candidate-authorised, not checked against the notification.",
  topics: [
    {t: "Asymptotic analysis and recurrence relations", lessons: ["algo-recurrence"]},
    {t: "Divide and conquer", lessons: ["algo-recurrence"]},
    {t: "Greedy algorithms", lessons: ["algo-greedy-dp"]},
    {t: "Dynamic programming", lessons: ["algo-greedy-dp"]},
    {t: "Graph algorithms: traversal, MST, shortest paths", lessons: ["algo-graphs"]},
    {t: "Searching, sorting and lower bounds", lessons: ["algo-graphs"],
    ...
    {t: "Complexity classes: P, NP, NP-complete, NP-hard", lessons: ["algo-greedy-dp"]},
  ],
},
...
"Compiler Design": {
  ...
  basis: "GATE CS scope, as reported for HAL's discipline section — candidate-authorised, not checked against the notification.",
  topics: [
    {t: "Phases of a compiler", lessons: ["cd-phases"]},
    {t: "Lexical analysis and token specification", lessons: ["cd-phases"]},
    {t: "Parsing: top-down (LL) and bottom-up (LR)", lessons: ["cd-parsing"]},
    {t: "Syntax-directed translation and semantic analysis", lessons: ["cd-parsing"]},
    {t: "Intermediate code generation", lessons: ["cd-intermediate"]},
    {t: "Code optimisation", lessons: ["cd-intermediate"]},
    {t: "Runtime environments and activation records", lessons: ["cd-intermediate"]},
...
"Discrete Mathematics": {
  ...
  topics: [
    {t: "Propositional and predicate logic", lessons: ["dm-logic-sets"]},
    {t: "Sets, relations and functions", lessons: ["dm-logic-sets"]},
    {t: "Combinatorics: permutations, combinations, pigeonhole", lessons: ["dm-counting"]},
    {t: "Probability", lessons: ["dm-counting"]},
    {t: "Graph theory", lessons: ["dm-graphs"]},
    {t: "Matrices, determinants and eigenvalues", lessons: ["dm-graphs"]},
...
"Reasoning": {
  ...
  topics: [
    ...
    {t: "Syllogisms and statement-conclusion", skills: ["syllogism-some-proves-nothing"]},
    ...
    {t: "Venn diagrams and set-based reasoning", exams: ["ssc-cgl", "ts-si"]},
